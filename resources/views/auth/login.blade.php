...
<head>
    ...
    <style>
        ...
        /* Moving gradient background (subtle) */
...
<body class="h-full min-h-screen">
    ...
    <div class="fixed inset-0 bg-anim"
         style="background-image: linear-gradient(135deg, #0f172a, #1e3a8a, #2563eb);">
    </div>

    <!-- ✅ Overlay -->
    <div class="fixed inset-0 bg-black/35 dark:bg-black/60"></div>
        ...
        <div class="w-full max-w-md">
            ...
            <div class="card-animate rounded-2xl bg-white/95 dark:bg-gray-900/95 backdrop-blur shadow-2xl border border-white/30 dark:border-gray-700">
                <div class="p-7 sm:p-8">
                    ...
                    <p class="text-sm text-gray-500 dark:text-gray-300 mt-1">Accédez à votre espace.</p>
