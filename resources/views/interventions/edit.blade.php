    ...
    <div class="py-10">
        <div class="max-w-4xl mx-auto px-4">
            ...
            <div class="flex items-center justify-between mb-8">
                <div>
                    <h1 class="text-2xl font-bold text-gray-900">Modifier intervention</h1>
                    <p class="text-sm text-gray-500 mt-1">Mettez à jour l'intervention puis enregistrez.</p>
                </div>
                ...
                <div class="p-6 grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <select name="panne_id" required
                            ...
                            @foreach($pannes as $p)
                                <option value="{{ $p->id }}" @selected(old('panne_id', $intervention->panne_id)==$p->id)>
                    ...
                    <div>
                        ...
                        <select name="statut_apres"
                            ...
                            <option value="nouvelle" @selected(old('statut_apres', $intervention->statut_apres)==='nouvelle')>Nouvelle</option>
                            <option value="en_cours" @selected(old('statut_apres', $intervention->statut_apres)==='en_cours')>En cours</option>
                            <option value="resolue"  @selected(old('statut_apres', $intervention->statut_apres)==='resolue')>Résolue</option>
                        </select>
                    </div>
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea name="description" rows="5"
                                  class="w-full rounded-lg border-gray-300 focus:border-blue-500 focus:ring-blue-500">{{ old('description', $intervention->description) }}</textarea>
                    </div>
