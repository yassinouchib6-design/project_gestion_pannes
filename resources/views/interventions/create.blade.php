        ...
        <div class="max-w-4xl mx-auto px-4">
            ...
            <div class="flex items-center justify-between mb-8">
                <div>
                    ...
                    <p class="text-sm text-gray-500 mt-1">
                        Ajoutez une intervention liée à une panne.
                    </p>
                </div>
            ...
            <form method="POST" action="{{ route('interventions.store') }}"
                ...
                <div class="p-6 grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="md:col-span-2">
                        <label class="block text-sm font-medium text-gray-700 mb-1">
                            Panne <span class="text-red-500">*</span>
                        </label>

                        <select name="panne_id"
                        ...
                        <div class="md:col-span-2">
                            ...
                            <select name="technicien_id"
                                ...
                                @foreach ($techniciens as $t)
                                    <option value="{{ $t->id }}"
                                        {{ old('technicien_id') == $t->id ? 'selected' : '' }}>
                                        {{ $t->name }} ({{ $t->email }})
                                    </option>
                                @endforeach
                            </select>
                    ...
                    <div>
                        ...
                        <select name="statut_apres"
                            ...
                            <option value="nouvelle" @selected(old('statut_apres') === 'nouvelle')>
                                Nouvelle
                            </option>
                            <option value="en_cours" @selected(old('statut_apres') === 'en_cours')>
                                En cours
                            </option>
                            <option value="resolue" @selected(old('statut_apres') === 'resolue')>
                                Résolue
                            </option>
                        </select>
                    </div>
                ...
                <div class="flex items-center justify-end gap-3 border-t bg-gray-50 px-6 py-4 rounded-b-2xl">
                    ...
                    <button type="submit"
                            class="inline-flex items-center gap-2 rounded-xl bg-blue-600 px-6 py-2.5
                                   text-sm font-semibold text-white shadow-md shadow-blue-600/30
                                   hover:bg-blue-700">
                        Enregistrer
                    </button>
                </div>
